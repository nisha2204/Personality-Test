...
def result(string):
	...
	if(string == 'ADVOCATE'):return render_template('Advocate.html')
	if(string == 'CAMPAIGNER'):return render_template('Campaigner.html')
	if(string == 'COMMANDER'):return render_template('Commander.html')
	if(string == 'CONSUL'):return render_template('Consul.html')
	if(string == 'DEBATER'):return render_template('Debater.html')
	if(string == 'DEFENDER'):return render_template('Defender.html')
	if(string == 'EXECUTIVE'):return render_template('Executive.html')
	if(string == 'LOGICIAN'):return render_template('Logician.html')
	if(string == 'LOGISTICIAN'):return render_template('Logistician.html')
	if(string == 'MEDIATOR'):return render_template('Mediator.html')
	if(string == 'PROTAGONIST'):return render_template('Protagonist.html')
	if(string == 'ADVENTURER'):return render_template('Adventurer.html')
	if(string == 'ENTERTAINER'):return render_template('Entertainer.html')
	if(string == 'ENTREPRENEUR'):return render_template('Entrepreneur.html')
	if(string == 'VIRTUOSO'):return render_template('Virtuoso.html')
...
def my_form_post():
	...
	string = dct(text1,text2,text3,text4,processed_text5)
	x = result(string)
	return x
...
def evaluate():
	...
	string = dct(c1,c2,c3,c4,c5)
	x = result(string)
	return x

if __name__=='__main__':
    app.run(host='192.168.43.76', port=PORT, debug=True)
